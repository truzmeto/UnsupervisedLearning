...
\begin{figure}
  \center
    \includegraphics[width=14.0cm]{plots/AD_ModComp_EM.pdf}
    \includegraphics[width=14.0cm]{plots/AD_ModComp_Kmeans.pdf}
  \center
  \caption{}
...
## 3. Reproduce your clustering experiments, but on the data after you've run dimensionality reduction on them 



## 4. Rerun your neural network learner on the newly projected(reduced dimension) data
